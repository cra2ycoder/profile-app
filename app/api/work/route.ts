  ...
  return NextResponse.json(
    {
      data: [
        ...
        },
        {
          ...
          duration: '2009 - 2019',
          responsibilities: [
            'Leading a design team to craft professional <span class="dark:text-white text-black font-bold">User Interfaces (UI)</span> and deliver exceptional <span class="dark:text-white text-black font-bold">User experiences (UX)</span> for web applications and mobile apps, leveraging tools like <span class="dark:text-white text-black font-bold">Adobe Photoshop, Adobe XD, and Figma.</span>',
