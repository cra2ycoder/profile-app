export default function Footer() {
  ...
  return (
    <footer className="border-t py-2 gap-3 dark:border-gray-800 border-gray-300 flex md:justify-between flex-row flex-wrap md:flex-nowrap justify-center text-center sm:text-left">
